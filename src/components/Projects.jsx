...
const ProjectCard = ({ image, title, description, git, technologies }) => {
    return (
        <div className="max-w-sm sm:max-w-sm md:max-w-sm bg-gray-900 border border-neutral-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {title==='AlgVisualizer' && <a href="https://algvisualizer-site.netlify.app/">
                <img className="w-full rounded-t-lg h-auto object-cover " src={algvisualizer} alt="" />
            </a>}
            {title==='Extractive Summarizer' && <a href="https://easyextractivesummarizer.pythonanywhere.com/">
                <img className="w-full rounded-t-lg h-auto object-cover " src={extractive} alt="" />
            </a>}
